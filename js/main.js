...
const productos = [
    new Producto(1, 'Dolares', 1270, 100000, './image/dolares.jpg'),
    new Producto(2, 'Euros', 1310, 1000000, './image/euros.jpg'),
    new Producto(3, 'Pesos Uruguayos', 12, 1000000, './image/pesouruguayo.jpg'),
    new Producto(4, 'Reales Brasil', 166, 1000000, './image/realesbrasil.jpg'),
